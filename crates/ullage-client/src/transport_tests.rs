...
static SERVICE_FAKE_LOCK: std::sync::Mutex<()> = std::sync::Mutex::new(());
static SERVICE_FAKE_INSTALLED: std::sync::atomic::AtomicBool =
    std::sync::atomic::AtomicBool::new(false);
static SERVICE_FAKE_STOP_ISSUED: std::sync::atomic::AtomicBool =
    std::sync::atomic::AtomicBool::new(false);
static SERVICE_FAKE_CALLS: std::sync::Mutex<Vec<&'static str>> = std::sync::Mutex::new(Vec::new());
static SERVICE_FAKE_START_SOCKET: std::sync::Mutex<Option<PathBuf>> = std::sync::Mutex::new(None);
