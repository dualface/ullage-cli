...
use ullage_core::{
    ...
    ProviderId, ProviderRegistry, ProviderResult, QueryOutcome, SubscriptionUsage,
    UsageMeasurement, UsageQuery, UsageWindow, UsageWindowKind,
};
use ullage_daemon::{
...
impl Harness {
    ...
    async fn start_with_first_query(
    ...
    async fn start_with_pairing_and_query(
        allowed_origins: Vec<String>,
        probe_min_interval: Duration,
        pair_device: bool,
