...
usable Overview ratio across enabled accounts. Overview retains every window in each account's
shortest available time tier, and a reached limit in those retained windows takes precedence as 0%.
